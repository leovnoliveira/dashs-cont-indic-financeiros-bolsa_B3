...
renderEcharts4r({
  ...
  echarts4r::e_title("Balanço Patrimonial", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
...
dre |> 
  ...
  echarts4r::e_title("DRE", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
  echarts4r::e_legend(right = 0) |> 
  echarts4r::e_theme("auritus") |> 
  echarts4r::e_tooltip(trigger = "axis") 
})
...
echarts4r::renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_title("Liquidez Corrente", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Liquidez Imediata", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Liquidez Seca", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Liquidez Geral", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Divida/PL", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Divida/Ativos", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Divida/EBIT", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("PL/Ativos", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Passivos/Ativos", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Margem Bruta", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Margem Líquida", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Margem EBIT", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("ROIC", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("ROE", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("ROA", "Fonte: CVM/B3 | Elaborado por analisemacro.com.br") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
