...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("Margem EBIT", "Fonte: CVM/B3 | Elaborado por Leonardo Oliveira") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("ROIC", "Fonte: CVM/B3 | Elaborado por Leonardo Oliveira") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("ROE", "Fonte: CVM/B3 | Elaborado por Leonardo Oliveira") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
...
renderEcharts4r({
  ...
  dplyr::filter(denom_cia == input$companies) |> 
    ...
    echarts4r::e_mark_line(data = avg, title = "Média") |> 
    echarts4r::e_title("ROA", "Fonte: CVM/B3 | Elaborado por Leonardo Oliveira") |> 
    echarts4r::e_theme("auritus") |> 
    echarts4r::e_tooltip(trigger = "axis")
})
```
